...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome, to Engineering Camp 2024. You can ask me for the next talk or ask for help!';
...
const NextTalkIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'NextTalkIntent';
    },
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'You can aks for the next talk in the schedule.';
...
exports.handler = Alexa.SkillBuilders.custom()
    ...
    .addErrorHandlers(
        ErrorHandler)
    .withCustomUserAgent('ec24-skill/v1.2')
    .lambda();